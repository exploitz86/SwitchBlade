...
class CheatDownloadView : public brls::Box {
public:
    CheatDownloadView(const std::string& url, const std::string& version, bool isGraphicsCheats = false, bool extractAll = false);
    ~CheatDownloadView() {
