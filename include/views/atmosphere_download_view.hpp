...
class AtmosphereDownloadView : public brls::Box {
public:
    AtmosphereDownloadView(const std::string& name, const std::string& url, bool offerHekateDownload = false, const std::string& hekateUrl = "");
    ~AtmosphereDownloadView() {
...
private:
    std::string cfwName;
    std::string cfwUrl;
    bool shouldOfferHekate;
    std::string hekateDownloadUrl;
